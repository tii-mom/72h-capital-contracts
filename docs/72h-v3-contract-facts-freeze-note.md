...
Freeze time: `2026-05-01T16:15:36.246Z`

Use this note for website, WAN, Terminal, and `multi-millionaire` integration updates. This note is read-only public fact material. It is not a signing package, root publication approval, presale approval, or owner operation approval.
...
- `contracts/apps/multi-millionaire/v3/` is only a reserved production-candidate workspace. It is not deployed and must not be represented as live chain infrastructure.
